...
class LossYolov5(nn.Module):
    def __init__(self, *args, **kwargs):
        super(LossYolov5, self).__init__()

    def forward(self, p, targets, model):
        return self.compute_loss(p, targets, model)
